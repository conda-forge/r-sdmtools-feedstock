...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-sdmtools-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-sdmtools-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-sdmtools-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-sdmtools-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-sdmtools-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-sdmtools-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-sdmtools/badges/version.svg)](https://anaconda.org/conda-forge/r-sdmtools)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-sdmtools/badges/downloads.svg)](https://anaconda.org/conda-forge/r-sdmtools)
